...
if (
  approvals.productionEnquiryFormIntegrated === true &&
  (
  consultationFormSource.includes("Prototype boundary: this form does not send data anywhere yet") ||
  consultationFormSource.includes("window.setTimeout")
  )
) {
  block("The public consultation form still contains simulated prototype submission behaviour.");
}
...
console.log("\nCYA Phase 11.5.4 launch-readiness gate");
