...
export default function WorkplaceWellbeingProgramsPage() {
  return (
    <>
      ...
      <section id="program-structure" className="bg-[var(--cya-canvas)] py-20 lg:py-24">
        <ProductionContainer>
      ...
      <section className="bg-white py-20 lg:py-24">
        <ProductionContainer>
          ...
          <aside className="mt-10 border-l-4 border-[var(--cya-ochre)] bg-[var(--cya-canvas)] px-7 py-6">
