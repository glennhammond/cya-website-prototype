    ...
    <>
      ...
      <section className="bg-[var(--cya-surface-page)] py-16 lg:py-20">
        <ProductionContainer className="grid max-w-[1440px] gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:items-center lg:gap-14 xl:gap-16">
          ...
          <figure className="relative aspect-[3/2] overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]">
            <Image src="/images/selected/cya-workplace-wellbeing-hero-warehouse-group.webp" alt="Employees take part in a facilitated workplace yoga session in a warehouse" fill priority sizes="(min-width: 1440px) 650px, (min-width: 1024px) 46vw, 100vw" className="object-cover" />
          </figure>
        </ProductionContainer>
      </section>
      ...
      <section id="program-structure" className="bg-[var(--cya-surface-base)] py-20 lg:py-24">
        <ProductionContainer>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <article className="overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]"><figure className="relative aspect-[3/2]"><Image src="/images/selected/cya-home-oneoff-desk-stretch.webp" alt="A facilitator guides an employee through an accessible workplace movement session" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" /></figure><div className="p-6"><h3 className="text-2xl font-semibold text-[var(--cya-teal-dark)]">Office-based teams</h3><p className="mt-3 leading-7 text-[var(--cya-body)]">Accessible sessions that fit meeting rooms, shared spaces and the working day.</p></div></article>
            <article className="overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]"><figure className="relative aspect-[3/2]"><Image src="/images/selected/cya-movement-group-industrial.webp" alt="Employees pause together during a facilitated session in an industrial workplace" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" /></figure><div className="p-6"><h3 className="text-2xl font-semibold text-[var(--cya-teal-dark)]">Operational workplaces</h3><p className="mt-3 leading-7 text-[var(--cya-body)]">Practical formats adapted to the environment, workforce and available space.</p></div></article>
            <article className="overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]"><figure className="relative aspect-[3/2]"><Image src="/images/selected/cya-programs-multisite-outdoor.webp" alt="Employees in high-visibility workwear take part in an outdoor wellbeing session" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" /></figure><div className="p-6"><h3 className="text-2xl font-semibold text-[var(--cya-teal-dark)]">Multi-site and distributed teams</h3><p className="mt-3 leading-7 text-[var(--cya-body)]">Coordinated delivery across locations, schedules and different ways of working.</p></div></article>
            <article className="overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]"><figure className="relative aspect-[3/2]"><Image src="/images/selected/cya-conferences-studio-remote-grid.webp" alt="Employees join an online wellbeing session from different locations" fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" /></figure><div className="p-6"><h3 className="text-2xl font-semibold text-[var(--cya-teal-dark)]">Hybrid and online participation</h3><p className="mt-3 leading-7 text-[var(--cya-body)]">Live connection and Wellbeing Studio support between in-person sessions.</p></div></article>
          </div>
        </ProductionContainer>
      </section>
      ...
      <section className="bg-[var(--cya-surface-page)] py-20 lg:py-24">
        <ProductionContainer>
          ...
          <div className="mt-8 grid gap-6 border border-[var(--cya-divider)] bg-[var(--cya-surface-subtle)] px-8 py-9 md:grid-cols-[1fr_auto] md:items-center"><div><ProductionKicker>Flexible starting points</ProductionKicker><h3 className="mt-4 text-2xl font-semibold">Start with the level of support your organisation needs</h3><p className="mt-3 max-w-3xl text-[var(--cya-body)]">Begin with a focused pilot, a regular session schedule or a broader ongoing program. We will help you define a practical starting point.</p></div><ProductionAction href="/contact?interest=program">Start planning</ProductionAction></div>
        </ProductionContainer>
      </section>
        ...
        <ProductionContainer>
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center lg:gap-14">
            <div className="border-y border-[var(--cya-divider)]">
              <article className="grid grid-cols-[2.5rem_1fr] gap-4 border-b border-[var(--cya-divider)] py-6"><p className="pt-1 text-xs font-semibold text-[var(--cya-ochre-ink)]">01</p><div><h3 className="text-xl font-semibold text-[var(--cya-teal-dark)]">Fits the working day</h3><p className="mt-2 leading-7 text-[var(--cya-body)]">Choose times, formats and locations that reflect how your people work.</p></div></article>
              <article className="grid grid-cols-[2.5rem_1fr] gap-4 border-b border-[var(--cya-divider)] py-6"><p className="pt-1 text-xs font-semibold text-[var(--cya-ochre-ink)]">02</p><div><h3 className="text-xl font-semibold text-[var(--cya-teal-dark)]">Clear to participants</h3><p className="mt-2 leading-7 text-[var(--cya-body)]">Explain what the experience involves, who it is for and how people can join.</p></div></article>
              <article className="grid grid-cols-[2.5rem_1fr] gap-4 py-6"><p className="pt-1 text-xs font-semibold text-[var(--cya-ochre-ink)]">03</p><div><h3 className="text-xl font-semibold text-[var(--cya-teal-dark)]">Voluntary and privacy-aware</h3><p className="mt-2 leading-7 text-[var(--cya-body)]">Use aggregate participation and voluntary feedback to improve delivery without assessing individual wellbeing.</p></div></article>
            </div>
            <figure className="relative aspect-[3/2] overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]"><Image src="/images/selected/cya-programs-participation-outdoor-group.webp" alt="Employees take part in a facilitated outdoor workplace yoga session" fill sizes="(min-width: 1280px) 650px, (min-width: 1024px) 52vw, 100vw" className="object-cover" /></figure>
          </div>
        </ProductionContainer>
      </section>
      ...
      <section className="bg-[var(--cya-surface-page)] py-20 lg:py-24">
        <ProductionContainer className="grid gap-10 lg:grid-cols-[minmax(0,1.02fr)_minmax(0,0.98fr)] lg:items-center lg:gap-14">
          <div><ProductionKicker>Experience in practice</ProductionKicker><h2 className="mt-5 max-w-3xl text-4xl font-bold lg:text-5xl">Workplace wellbeing delivered for established organisations</h2><p className="mt-6 max-w-3xl text-lg leading-8 text-[var(--cya-body)]">Our client relationships include Cromwell Property Group. We bring the same careful planning, coordination and participant-focused delivery to every workplace program.</p><p className="mt-4 max-w-3xl text-sm leading-6 text-[var(--cya-body)]">Program details, results and client comments are only published when they have been verified and approved.</p><div className="mt-8"><ProductionAction href="/contact?interest=program" style="secondary">Discuss a similar need</ProductionAction></div></div>
          <figure className="overflow-hidden border border-[var(--cya-divider)] bg-[var(--cya-surface-base)]"><div className="relative aspect-[4/3]"><Image src="/images/selected/cya-workplace-wellbeing-lunch-learn-team.webp" alt="Employees take part in a facilitated movement session at work" fill sizes="(min-width: 1024px) 44vw, 100vw" className="object-cover" /></div><figcaption className="border-t border-[var(--cya-divider)] px-5 py-3 text-sm text-[var(--cya-body)]">Representative workplace delivery</figcaption></figure>
        </ProductionContainer>
      </section>
      ...
      <section className="bg-[var(--cya-surface-subtle)] py-20 lg:py-24">
        <ProductionContainer>
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            <ProductionCard title="Fit the workday" body="Consider locations, schedules, operational demands, accessibility and the time people can realistically use." tone="white" />
            <ProductionCard title="Keep participation voluntary" body="Give people clear information and more than one useful way to take part without monitoring individual wellbeing." tone="white" />
            <ProductionCard title="Learn proportionately" body="Review access, delivery, aggregate participation and voluntary feedback without claiming health, productivity or compliance outcomes." tone="white" />
          </div>
          <aside className="mt-10 border-l-4 border-[var(--cya-ochre)] bg-[var(--cya-surface-page)] px-7 py-6"><h3 className="text-2xl font-semibold text-[var(--cya-teal-dark)]">Where CYA fits alongside psychosocial risk management</h3><p className="mt-3 max-w-4xl leading-7 text-[var(--cya-body)]">Wellbeing activities can complement a broader organisational approach, but they do not replace identifying psychosocial hazards, consulting workers, assessing and controlling risks, reviewing controls, changing harmful work conditions or obtaining appropriate WHS, clinical or legal advice. CYA is a workplace wellbeing provider, not an EAP or psychosocial-compliance service.</p></aside>
      ...
      <section className="bg-[var(--cya-surface-base)] py-20 lg:py-24">
        <ProductionContainer>
          ...
          <div className="mt-10 border-t border-[var(--cya-divider)]">
            ...
            ].map(([question, answer]) => <details key={question} className="group border-b border-[var(--cya-divider)]"><summary className="flex cursor-pointer list-none items-center justify-between gap-6 py-6 text-lg font-semibold text-[var(--cya-teal-dark)] [&::-webkit-details-marker]:hidden"><span>{question}</span><span aria-hidden="true" className="text-2xl font-normal leading-none transition-transform group-open:rotate-45">+</span></summary><p className="max-w-4xl pb-6 pr-12 leading-7 text-[var(--cya-body)]">{answer}</p></details>)}
          </div>
        </ProductionContainer>
      </section>
