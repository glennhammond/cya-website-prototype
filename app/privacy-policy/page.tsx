        ...
        <ProductionContainer>
          <article className="max-w-4xl space-y-12 text-base leading-7 text-[var(--cya-body)]">
            ...
            <section>
              ...
              <p className="mt-4">When you submit a <strong>Plan with CYA</strong> enquiry, we use the information you provide to respond to and manage that enquiry.</p>
            ...
            <p className="border-t border-[var(--cya-divider)] pt-8 text-sm leading-6">
              This review page is intentionally excluded from search until the policy is approved. Return to <Link className="font-semibold underline underline-offset-4" href="/contact">Plan with CYA</Link>.
            </p>
          </article>
        </ProductionContainer>
      </section>
