      ...
      <section className="bg-[var(--cya-surface-page)] py-12 sm:py-16 lg:py-20">
        <ProductionContainer>
          <div className="max-w-4xl">
            ...
            <h1 className="mt-4 text-[clamp(2.5rem,7vw,4.5rem)] font-bold leading-[1.04] text-[var(--cya-teal-dark)]">Corporate Yoga Australia Privacy Policy</h1>
            <div className="mt-7 border-l-4 border-[var(--cya-ochre)] bg-white p-5 text-sm leading-6 text-[var(--cya-body)]">
              <p className="font-bold text-[var(--cya-teal-dark)]">Working draft — 29 August 2026</p>
              <p className="mt-2">This is a plain-English working draft for business and privacy review. It must not be published as final until the operational checks are complete and the wording is approved by Debby Lewis and the appointed privacy/legal reviewer.</p>
            </div>
          </div>
        </ProductionContainer>
      </section>
      ...
      <section className="bg-white py-12 sm:py-16 lg:py-20">
        <ProductionContainer>
          <article className="max-w-4xl space-y-12 text-base leading-7 text-[var(--cya-body)]">
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">1. About this policy</h2>
              ...
              <p className="mt-4">In this policy, <strong>Corporate Yoga Australia</strong>, <strong>CYA</strong>, <strong>we</strong>, <strong>us</strong> and <strong>our</strong> refer to Deborah Gail Lewis, ABN 59 474 451 715, trading as Corporate Yoga Australia.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">2. What personal information we collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">3. How we collect personal information</h2>
              ...
              <p className="mt-4">We may also receive relevant information from your employer or the organisation arranging a CYA service; an authorised organiser, contact person or event partner; a facilitator or service provider working with us; or our website, communications and analytics systems.</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">4. Why we collect and use personal information</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">5. Enquiries and marketing communications</h2>
              <p className="mt-4">When you submit a <strong>Start planning</strong> enquiry, we use the information you provide to respond to and manage that enquiry.</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">7. Overseas processing and disclosure</h2>
              ...
              <p className="mt-4">Before publication of this policy, CYA will identify the service providers that handle personal information, determine whether overseas disclosure is likely and, where practicable, state the relevant countries. Where overseas processing or disclosure occurs, we will take reasonable steps appropriate to the circumstances to protect the information and comply with applicable Australian privacy requirements.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">8. Website analytics, cookies and similar technologies</h2>
              ...
              <p className="mt-4">Before publication of this policy, CYA will confirm the analytics and tracking tools present on the production website, their purposes, applicable retention settings and whether a consent or cookie-management mechanism is required.</p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">9. How we hold and protect personal information</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">10. How long we retain personal information</h2>
              ...
              <p className="mt-4">Before publication of this policy, CYA will confirm the practical retention rules applying to website enquiries, client and participant records, analytics data and marketing records.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">11. Accessing or correcting your personal information</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">12. Privacy questions and complaints</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">13. Third-party websites and services</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">14. Changes to this policy</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[var(--cya-teal-dark)]">15. Contact us</h2>
              <address className="mt-4 not-italic"><strong>Corporate Yoga Australia</strong><br />Deborah Gail Lewis, ABN 59 474 451 715, trading as Corporate Yoga Australia<br />Email: <a className="font-semibold underline underline-offset-4" href="mailto:info@corporateyoga.com.au">info@corporateyoga.com.au</a><br />Phone: <a className="font-semibold underline underline-offset-4" href="tel:1300373363">1300 373 363</a></address>
              <p className="mt-4"><strong>Effective date:</strong> To be inserted following approval.</p>
            </section>

            <p className="border-t border-[var(--cya-divider)] pt-8 text-sm leading-6">This review page is intentionally excluded from search until the policy is approved. Return to <Link className="font-semibold underline underline-offset-4" href="/contact">Start planning</Link>.</p>
          </article>
        </ProductionContainer>
      </section>
    </>
