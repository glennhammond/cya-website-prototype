...
export const proofHero: PageIntro = {
  kicker: "Proof",
  heading: "Evidence placed where the doubt actually arises.",
  body: "CYA's value is demonstrated through the situation, decisions, delivery and evidence behind each engagement — not unsupported claims. Every story below is a governed placeholder until client permission, dates and facts are confirmed.",
};

export const proofPrinciples = [
  "Every public proof item is tied to permission, evidence, context and an approver.",
  "No client name, logo, quotation, metric or photograph publishes without a recorded approval.",
  "Every number carries its source, denominator, period and limitations.",
  "CYA does not restore an unexplained logo wall — proof appears with context, near the decision it supports.",
];
...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    clientLabel: "One-off / event proof — candidate to be identified",
